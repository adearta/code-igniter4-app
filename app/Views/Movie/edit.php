...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h2 class="my-3">Form Edit Data Film</h2>
            <!-- kita cetak $validation, kita ambil semua error yang tampil -->
            <!-- pake phpp $validation->listErrors(); -->

            <form action="/movie/update/<?= $editmovie['id']; ?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="slug" value="<?= $editmovie['slug']; ?>">
                <input type="hidden" name="coverlama" value="<?= $editmovie['cover']; ?>">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" id="judul" name="judul" autofocus value="<?= (old('judul')) ? old('judul') : $editmovie['judul'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="sutradara" name="sutradara" value="<?= (old('sutradara')) ? old('sutradara') : $editmovie['sutradara'] ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="rumahproduksi" class="col-sm-2 col-form-label">rumah produksi</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="rumahproduksi" name="rumahproduksi" value="<?= (old('rumahproduksi')) ? old('rumahproduksi') : $editmovie['rumahproduksi'] ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="cover" class="col-sm-2 col-form-label">cover</label>
                    <div class="col-sm-2">
                        <img src="/img/<?= $editmovie['cover']; ?>" class="img-thumbnail img-preview">
                    </div>
                    <div class="col-sm-8">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="cover"><?= $editmovie['cover']; ?></label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
